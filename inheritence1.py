...
# class Athlets:
#     def display1(se):
#         print("Athletics is Very Good for Health. ")

# class Cricket:
#     def __init__(sl ):
#         print ("The Cricket is The Most Popular Game In India.   ")        

# class Player(Athlets,Cricket):
#     def display2(S):
#         print ("So Maximum YoungStars in India dreamt to be a Cricketing Athlet   ") 
# p=Player()
# p.display1()
# p.display2()
